import type { PokeContext, LayoutInfo } from './types.js';

const MAX_TEXT_LENGTH = 200;
const SEPARATOR = '━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━';

export function formatPokeContext(ctx: PokeContext): string {
  const lines: string[] = [];
  ...
  const attrEntries = Object.entries(ctx.dom.attributes).filter(
    ([k]) => k !== 'class' && k !== 'id',
  );
...
function formatLayout(layout: LayoutInfo): string {
  const lines: string[] = [];

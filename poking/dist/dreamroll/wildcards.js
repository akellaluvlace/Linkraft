...
exports.getRandomWildcard = getRandomWildcard;
exports.getRandomWildcardByCategory = getRandomWildcardByCategory;
exports.WILDCARDS = [
    // Era-specific
...
function getRandomWildcard() {
    const index = Math.floor(Math.random() * exports.WILDCARDS.length);
    return exports.WILDCARDS[index];
}
/**
 * Returns a random wildcard from a specific category.
 */
function getRandomWildcardByCategory(category) {
    const filtered = exports.WILDCARDS.filter(w => w.category === category);
